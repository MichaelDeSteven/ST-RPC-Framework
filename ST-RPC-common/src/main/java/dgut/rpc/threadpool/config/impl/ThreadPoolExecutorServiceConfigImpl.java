...
import dgut.rpc.threadpool.config.ConfigEntity;
...
public class ThreadPoolExecutorServiceConfigImpl extends AbstractServiceConfigImpl {
    ...
    public ThreadPoolExecutorServiceConfigImpl(ThreadPoolExecutor threadPoolExecutor,
                                               String serverAddr, String dataId, String group) {
    ...
    public void modifyArg(int corePoolSize, int maxPoolSize, int workQueueSize) {
    ...
    protected void updateConfig(String s) {
        ConfigEntity entity = JSON.parseObject(s, ConfigEntity.class);
